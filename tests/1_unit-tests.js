...
suite("Unit Tests", function () {
  ...
  suite("Basic Assertions", function () {
    ...
    test("#isNull, #isNotNull", function () {
      assert.isNull(null, "Optional error description - e.g. null is null");
  ...
  suite("Arrays", function () {
    ...
    // #12 first paramter is array, second is the item we want to if it includes or does not include
